...
const messages = {
  'zh-TW': {
    ...
    interpretation: '即時口譯', interpretationHint: '開啟後，講者說外語時會用語音唸出翻譯（建議戴耳機）', interpretationBlocked: '點一下恢復語音', interpretationLive: '即時口譯（直播中）', interpretationReconnecting: '口譯重新連線中…',
  ...
  en: {
    ...
    interpretation: 'Live interpreter', interpretationHint: 'Speaks a translated voice-over when the presenter uses another language (headphones recommended)', interpretationBlocked: 'Tap to resume audio', interpretationLive: 'Live interpreter (streaming)', interpretationReconnecting: 'Interpreter reconnecting…',
